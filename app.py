...
class NLPApp:
    ...
    def login_gui(self):
        ...
        redirect_btn = Button(self.root, text='Register Now', width=12, height=1, command=self.register_gui)
    ...
    def register_gui(self):
        ...
        redirect_btn = Button(self.root, text='Login Now', width=12, height=1, command=self.login_gui)
        redirect_btn.pack(pady=(10,10))
    ...
    def home_gui(self):
        ...
        ner_btn = Button(self.root, text='Only sentiment working', width=30, height=4, command=self.perform_registration)
        ner_btn.pack(pady=(10,10))

        emotion_btn = Button(self.root, text='Only sentiment working', width=30, height=4, command=self.perform_registration)
        emotion_btn.pack(pady=(10,10))

        logout_btn = Button(self.root, text='Logout', width=12, height=1, command=self.login_gui)
